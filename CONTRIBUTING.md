# Contributing to `fxtract` development

We, the authors of the `fxtract` R package, use the same guide as is used for
...
The goal of this guide is to help you get up and contributing to `fxtract` as
...
To contribute a change to `fxtract`, you follow these steps:
...
1.  __Motivation__. Your pull request should clearly and concisely motivates the
   ...
   how your pull request solves it as concisely as possible.
    ...
    `fxtract` comes out it's easy for users to see what's changed. Add your
