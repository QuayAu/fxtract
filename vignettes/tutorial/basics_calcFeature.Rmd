...
# calcFeature
This is the main function of this package. Given a **user-defined** function `fun`, it calculates this function for each member of a group variable (e.g. participants in a study). 
