...
Everytime a dataset or a function is added to the R6 object, batchtools experiments of all possible combinations (problems $\times$ algorithms) are added to the batchtools registry as well. 
