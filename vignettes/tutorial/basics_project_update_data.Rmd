...
## Delete Old Data
Datasets are saved as batchtools problems (one problem for each ID of the grouping variable). Single problems can be removed:
```{r, message = FALSE}
my_project$remove_data("virginica")
```
