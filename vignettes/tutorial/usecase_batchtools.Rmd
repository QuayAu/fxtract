...
project = useSqlDatabase(project = project, file.dir = "SQL_database_studentlife.sql", tbl_name = "studentlife_small_00", group_by = "userId")
project = useSqlDatabase(project = project, file.dir = "SQL_database_studentlife.sql", tbl_name = "studentlife_small_rest", group_by = "userId")
```
