...
project = sqlToRds(project = project, file.dir = "SQL_database_studentlife.sql", tbl_name = "studentlife_small_00")
project = sqlToRds(project = project, file.dir = "SQL_database_studentlife.sql", tbl_name = "studentlife_small_rest")
```
