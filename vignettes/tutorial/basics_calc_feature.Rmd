...
---
Given a **user-defined** function `fun`, `calc_features` calculates this function for each ID of a grouping variable (e.g. participants in a study).
...
This function works fine for small datasets and few features. But if your dataset is too big and you have many complicated features, then it's highly advised to use the R6 object ``Project`` (click [here](https://quayau.github.io/fxtract/docs/articles/tutorial/basics_project.html)).
