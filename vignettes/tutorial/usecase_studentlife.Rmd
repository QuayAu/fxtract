...
```{r}
feat_data = calc_feature(data = studentlife_small, fun = numberDiffApps, group_by = "userId")
feat_data
```
...
x = calc_feature(data = studentlife_small_weekday, fun = numberDiffApps, group_by = "userId", colname = "numberDiffAppsWeekday")
...
```{r}
x = calc_feature(data = studentlife_small_date, fun = numberDiffApps, group_by = c("userId", "date"))
x[, 1:6]
```
